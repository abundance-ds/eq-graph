...
The commands below refer to the repository state before 2026-09-03. Some scripts are now in archive/pipeline/ and some remain in pipeline/; Git history holds the deleted scripts.

| Script | Location |
|---|---|
| `pilot_2_0.py` | pipeline/ |
| `run_codex_eval.py` | Git history |
| `resolve_eligibility.py` | Git history |
| `enrich_abstracts.py` | Git history |
| `person_funnel.py` | Git history |
| `validate_screening_corpus.py` | Git history |
| `prepare_screening_pilot.py` | Git history |
| `run_screening_pilot.py` | archive/pipeline/ |
| `evaluate_screening.py` | archive/pipeline/ |
| `validate_screening_results.py` | Git history |
| `retrieve_fulltexts.py` | Git history |
| `prepare_fulltext_assessment.py` | Git history |
| `run_fulltext_assessment.py` | Git history |
| `prepare_funding_audit.py` | Git history |
| `run_funding_audit.py` | Git history |
| `validate_fulltext_assessment.py` | Git history |
| `prepare_project_assessment_v2.py` | Git history |
| `run_project_assessment_v2.py` | Git history |
| `evaluate_project_candidate_audit.py` | Git history |
| `validate_pilot_2_0.py` | Git history |
| `prepare_scale_inputs.py` | pipeline/ |
| `retrieve_scale_profiles.py` | pipeline/ |
| `prepare_profile_qa.py` | pipeline/ |
| `run_profile_qa.py` | pipeline/ |
| `evaluate_profile_qa.py` | pipeline/ |
| `prepare_scale_discovery.py` | pipeline/ |
| `retrieve_scale_identifier_sources.py` | pipeline/ |
| `prepare_scale_source_union.py` | pipeline/ |
| `validate_scale_source_union.py` | pipeline/ |
| `enrich_scale_abstracts.py` | pipeline/ |
| `validate_scale_abstract_enrichment.py` | pipeline/ |
| `prepare_scale_screening.py` | archive/pipeline/ |
| `run_screening_pilot.py` | archive/pipeline/ |
| `collect_scale_screening.py` | archive/pipeline/ |
| `prepare_scale_exclusion_audit.py` | archive/pipeline/ |
| `evaluate_scale_exclusion_audit.py` | archive/pipeline/ |
| `evaluate_funding_metadata_route.py` | Git history |
...
- The 2026-08-05 pause and its human-check condition are historical.
  Scale retrieval, processing, and the release completed between 2026-08-24 and 2026-08-29 on AI-based audits; see `scale/protocol-2.0/PAUSE_2026-08-05.md` and `docs/RESULTS.md`.
