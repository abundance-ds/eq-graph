Historical record. Copied verbatim from scripts/README.md on 2026-09-03.
The scrape pipeline of July 2026 did not produce the release; see [docs/HISTORY.md](../../docs/HISTORY.md).
...
The discovery scraper does not use OpenAlex. The current research release uses
OpenAlex only for a separate, DOI-based citation snapshot. See
