...
|---|---|---|---|
| Peripheral nerve-block use, project `1483-TVG` | None | The article states that EuroQol funded this work through a travel grant ([Disclosures](../../../corpus/1483-TVG/doi_10.1213_ane.0000000000007107.md#disclosures)). | Accept as direct support. Record `travel grant`. |
| Cultural values and self-reported health, project `2015150` | None | The article states that EuroQol funded this study ([Acknowledgements](../../../corpus/2015150/doi_10.1007_s11136-017-1512-x.md#acknowledgements)). | Accept as direct study support. |
| QID-12 development, project `429-RA` | No EQ responses or scores in the reported analysis; an input dataset has an EQ-5D-Y-5L evaluation label | The article states that EuroQol supported the data collections ([Funding](../../../corpus/429-RA/doi_10.1007_s11136-026-04223-x.md#funding)). | Accept as direct data-collection support. |
