...
- `CNF-P004` `InstrumentUse`: Amharic version of EQ-5D
...
- `CNF-P012` `MethodUse`: Level Sum Score (LSS) calculated by summing the scores across all five EQ-5D-5L dimensions
...
- `CNF-P015` `ProtocolUse`: EQ-VT protocol
