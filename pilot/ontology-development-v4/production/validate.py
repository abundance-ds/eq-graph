...
from schema import GAP_VALUES, HERE, build_schema, read_vocabulary
...
def validate_semantics(
    ...
    if disposition != "publication-context" and disposition != expected:
...
def validate_record(
    ...
    structural = sorted(
        Draft202012Validator(build_schema()).iter_errors(record),
