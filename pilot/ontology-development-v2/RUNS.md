...
| Consolidation | All 40 applications | `08f6b12` | `babce6f` | `cb56305` |
...
Each consolidation used a fresh agent, reviewed all 40 applications and verified the same source controls.
